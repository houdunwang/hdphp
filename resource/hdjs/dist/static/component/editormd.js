define(["hdjs", "jquery", 'css!dist/static/css/editormd.css'], function (hdjs, $) {
    return {
        markdown: function (elem, options) {
            require([
                "editormd",
                "dist/static/package/editor.md/languages/zh-tw",
                "dist/static/package/editor.md/plugins/link-dialog/link-dialog",
                "dist/static/package/editor.md/plugins/reference-link-dialog/reference-link-dialog",
                "dist/static/package/editor.md/plugins/image-dialog/image-dialog",
                "dist/static/package/editor.md/plugins/code-block-dialog/code-block-dialog",
                "dist/static/package/editor.md/plugins/table-dialog/table-dialog",
                "dist/static/package/editor.md/plugins/emoji-dialog/emoji-dialog",
